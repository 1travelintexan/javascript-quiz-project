describe("Quiz", () => {
  ...
  describe("shuffleQuestions() method", () => {
    ...
    it("should shuffle the items in the 'questions' array", () => {
      ...
      quiz.shuffleQuestions(); // Check if the questions array is not equal to the original array (it has been changed/shuffled)
  ...
  describe("filterQuestionsByDifficulty() method", () => {
    ...
    it("should be defined", () => {
      // Instantiate a new Quiz object
      const quiz = new Quiz([], 60, 60);
      // Check if the .filterQuestionByDifficulty is defined
    ...
    it("should be a function", () => {
      // Instantiate a new Quiz object
      const quiz = new Quiz([], 60, 60);
      // Check if the .filterQuestionByDifficulty is a function
    ...
    it("should receive 1 argument (difficulty)", () => {
      // Instantiate a new Quiz object
      const quiz = new Quiz([], 60, 60);
      // Check if the .filterQuestionByDifficulty receives one argument
      expect(quiz.filterQuestionsByDifficulty.length).toBe(1);
    });
    ...
    it("should update the 'questions' array with the questions filtered by difficulty", () => {
      ...
      const quiz2 = new Quiz([...questions], 60, 60);
      quiz2.filterQuestionsByDifficulty(1);
      expect(quiz2.questions).toEqual([
        {
          text: "Question 1",
          choices: ["a", "b", "c"],
          answer: "a",
    ...
    it("should not change the 'questions' array if the 1st argument is not a number between 1 and 3", () => {
      ...
      // Check if the .filterQuestionByDifficulty argument is of type number
  ...
  describe("averageDifficulty() method", () => {
    ...
    it("should return the average difficulty of the questions in the quiz as a number", () => {
      // Array with questions to be used in the test and passed to the Quiz constructor
      const questions = [
        {
          text: "Question 1",
      ...
      const quiz = new Quiz([...questions], 60, 60);
      expect(quiz.averageDifficulty()).toBe(2);
      let average = quiz.averageDifficulty();
